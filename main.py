...
BASIC_STRING = "An image containing one of the following: "
...
train_loader = DataLoader(calltech_train, batch_size=32, shuffle=True)
val_loader = DataLoader(calltech_val, batch_size=32)
...
csv_logger = CSVLogger("logs", name=f"fine-tune-clip_{datetime.now()}")
